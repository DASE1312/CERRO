...
include "../core/app/model/ConductaData.php";
...
$section1->addText("LISTA DE COMPORTAMIENTO - ".strtoupper($grado->nombre),array("size"=>22,"bold"=>true,"align"=>"right"));
...
if($asist!=null){
						if($asist->tipo==1){ $v="B"; }
						else if($asist->tipo==2){ $v="E"; }
						else if($asist->tipo==3){ $v="M"; }
						else if($asist->tipo==4){ $v= "MM"; }
